...
当name="find*"是，代表以find开头的所有方法。
  <tx:method name="*"/> 表示任意方法，配置为默认
```
...
如：<tx:annotation-driven transaction-manager="transactionManager"/> transactionManager:配置平台事务管理器
```
